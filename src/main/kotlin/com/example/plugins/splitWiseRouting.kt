...
fun Application.splitWiseRouting(dao: UserInterface, txnDao: com.example.models.dao.Transaction,
    ...
    routing {
        ...
        post("/transaction/default_split") {
            ...
            val transaction = txnDao.insert(UUID.randomUUID().toString(), userList, payee, amount, txn.description, txn.createdOn)
...
@Serializable
data class GetTxnReq(val txnId: String)
